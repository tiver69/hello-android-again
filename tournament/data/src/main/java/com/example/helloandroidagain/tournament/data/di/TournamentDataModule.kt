package com.example.helloandroidagain.tournament.data.di
...
import com.example.helloandroidagain.tournament.data.mapper.RemoteImageResponseConverter
import com.example.helloandroidagain.tournament.data.repository.local.ExportRepositoryImpl
import com.example.helloandroidagain.tournament.data.repository.local.ImageCacheRepositoryImpl
import com.example.helloandroidagain.tournament.data.repository.local.TournamentRepositoryImpl
import com.example.helloandroidagain.tournament.data.repository.remote.ImageRemoteApi
import com.example.helloandroidagain.tournament.data.repository.remote.ImageRemoteRepositoryImpl
